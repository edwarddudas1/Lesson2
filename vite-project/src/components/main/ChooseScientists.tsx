...
// export default function ChooseScientists() {
...
//      function ScientistBornBefore19() {
...
//   function longestAndShortestAge(){
//     const data = [...result].sort(
//         (a, b) => a.born - a.dead - (b.born - b.dead),
//     )
...
//             <div className="cards" key={scientist.id}>
...
//         <button onClick={ScientistBornBefore19}>Які вчені народилися в 19 ст.</button>
//         <button onClick={sortByName}>Відсортувати вчених за алфавітом</button>
//         <button onClick={sortByAge}>Відсортувати вчених за кількістю прожитих років</button>
//         <button onClick={latestBorn}>Знайти вченого, який народився найпізніше</button>
//         <button onClick={einsteinAge}>Знайти рік народження Albert Einshtein</button>
//         <button onClick={surnameC}>Знайти вчених, прізвища яких починаються на на літеру “С” </button>
//         <button onClick={surnameA}>Видалити всіх вчених, ім’я яких починається на “А”</button>
//         <button onClick={longestAndShortestAge}>Знайти вченого, який прожив найдовше і вченого, який прожив найменше</button>
//         <button onClick={sameLetters}>Знайти вчених, в яких співпадають перші літери імені і прізвища</button>
//         </>
//     )
// }
import { useState } from "react";
